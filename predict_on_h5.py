...
data = np.load("split5/H5_sequences.npy")
...
df.to_csv("H5_predictions.csv", index=False)
print("✅ Saved predictions to H5_predictions.csv")


try:
    label_df = pd.read_csv("H5_metadata_with_label.csv")
    ...
    plt.ylabel("True")
    plt.title("Confusion Matrix: H5")
    plt.tight_layout()
    plt.savefig("confusion_matrix_H5.png")
    print("📊 Confusion matrix saved to: confusion_matrix_H5.png")
