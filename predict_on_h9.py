...
data = np.load("split9/H9_sequences.npy")
...
df.to_csv("H9_predictions.csv", index=False)
print("✅ Saved predictions to H9_predictions.csv")


try:
    label_df = pd.read_csv("H9_metadata_with_label.csv")
    ...
    plt.ylabel("True")
    plt.title("Confusion Matrix: H9")
    plt.tight_layout()
    plt.savefig("confusion_matrix_H9.png")
    print("📊 Confusion matrix saved to: confusion_matrix_H9.png")
